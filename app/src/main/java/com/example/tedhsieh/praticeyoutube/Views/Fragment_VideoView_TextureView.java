...
public class Fragment_VideoView_TextureView extends Fragment implements TextureView.SurfaceTextureListener {

    MediaPlayer video_player;
    private String VideoTitle;
    private TextureView video_textureview;
    private SurfaceTexture video_surfacetexture;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        video_surfacetexture = null;
        isInSamllView = false;
        isStopPlaying = false;

        video_textureview = (TextureView) view.findViewById(R.id.videoview);
...
//        int navigationheight = navigationheightId>0 ? (getActivity().getResources().getDimensionPixelSize(navigationheightId)) : 0;
    ...
    public void onStop(){
        ...
        video_textureview.setVisibility(View.VISIBLE);
        removeVideoResouces();
        isStopPlaying = true;
    }

    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height){
        video_surfacetexture = surface;
        MaxDy = screen_size.y - (1- (1.0f - smallviewPercentage)*0.5f) * height;
        ...
        if(isStopPlaying){
            if(isShowVideoView){
                ...
                video_textureview.setVisibility(View.INVISIBLE);
            }
        }
        else {
    ...
    public void setShowAllView(){
        ...
        video_textureview.setVisibility(shouldShowVideoControl);
        setShowVideoControl();
    }
    ...
    public void setSurfaceOnTouchListener(){
        video_textureview.setOnTouchListener(new View.OnTouchListener() {
            float sy = 0.0f;
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if ((event.getAction() == MotionEvent.ACTION_UP) && shouldShowControlState && isShowVideoView && !isInSamllView) {
                    ...
                    VideoViewSizeAnimation animation = new VideoViewSizeAnimation(video_textureview, MaxDy, smallviewPercentage, 0.0f,
                            false, true, totalAnimationTime);
                    video_textureview.startAnimation(animation);
                    ...
                    VideoViewSizeAnimation animation;
                    ...
                    if (overThreshold) {
                        ...
                        animation = new VideoViewSizeAnimation(video_textureview, MaxDy, smallviewPercentage, normalized_dy,
...
//        while (!video_textureview.isAvailable());
        if(video_player == null) {

            video_player = new MediaPlayer();
            video_player.setSurface(new Surface(video_surfacetexture));
