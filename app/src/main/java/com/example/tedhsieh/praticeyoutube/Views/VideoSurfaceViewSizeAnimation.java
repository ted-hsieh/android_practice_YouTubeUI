...
public class VideoSurfaceViewSizeAnimation extends Animation{

    private SurfaceView video_textureview;
    private float MaxDy;
    ...
    public VideoSurfaceViewSizeAnimation(SurfaceView video_textureview, float MaxDy, float smallviewPercentage,
